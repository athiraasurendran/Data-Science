...
**Summary:**  
- **Bagging** → Parallel models, reduces variance (Random Forest).  
- **Boosting** → Sequential models, reduces bias (XGBoost, AdaBoost).  
- **Stacking** → Combines multiple models with a meta-model.  
- **Cascading** → Models arranged in sequence, each refining results.  
