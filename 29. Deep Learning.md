...
| Model       | Type                  | Use Case                                      |
| ----------- | --------------------- | --------------------------------------------- |
| FNN / MLP   | Feedforward           | Tabular data, basic classification/regression |
| CNN         | Convolutional         | Images, videos, spatial data                  |
| RNN         | Recurrent             | Sequential data, text, time series            |
| LSTM        | Recurrent (Long-term) | Long-term dependencies in sequences           |
| Autoencoder | Unsupervised          | Dimensionality reduction, anomaly detection   |
| GAN         | Generative            | Image generation, synthetic data              |
